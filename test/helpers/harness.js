...
// flow resolves to: the two framework skills plus the get-started orchestrator and its dispatch
// set. `packages` (keyed by skill id) defaults empty so the post-agent installer is a no-op;
...
export function makeSkillsDir(packages = {}) {
  ...
  const skills = [
    ...
    ['fingerprint-smart-signals', 'enhancement'],
    ['fingerprint-tagging', 'enhancement'],
    ['fingerprint-request-filtering', 'enhancement'],
    ['fingerprint-rules-engine', 'enhancement'],
  ]
